...
void setup()
{
  ...
  Serial.println(F("Benchmark                Tempo (microsegundos)"));
  delay(10);
  Serial.print(F("Screen preenche              "));
...
unsigned long testText()
{
  ...
  tft.println("Olá Mundo!");
   tft.println();
  tft.setTextColor(ILI9341_YELLOW);
  tft.setTextSize(2);
   tft.println();
  tft.println("Teste de escrita");
  //tft.setTextSize(3);
  ...
  tft.println("Producao de ovos");
  tft.setTextSize(2);
  tft.println();
  tft.setTextColor(ILI9341_BLUE);
  tft.println("Galinhas Embrapa 051");
  tft.println();
  tft.setTextColor(ILI9341_PINK);
  tft.println("Trato caipira");
  return micros() - start;
}
